...
const hrNavItems = [
  { href: '/dashboard', icon: LayoutDashboard, label: 'Dashboard', exact: true,
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'DEPARTMENT_HEAD', 'FINANCE_OFFICER', 'EMPLOYEE', 'SALES_MANAGER', 'SALES_AGENT', 'HEAD_OF_SALES'] },
  ...
  { href: '/dashboard/profile', icon: UserCircle, label: 'My Profile',
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'DEPARTMENT_HEAD', 'FINANCE_OFFICER', 'EMPLOYEE', 'SALES_MANAGER', 'SALES_AGENT', 'HEAD_OF_SALES'] },
  { href: '/dashboard/help', icon: HelpCircle, label: 'Help & Manual',
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'DEPARTMENT_HEAD', 'FINANCE_OFFICER', 'EMPLOYEE', 'SALES_MANAGER', 'SALES_AGENT', 'HEAD_OF_SALES'] },
...
const recruitmentNavItems = [
  { href: '/dashboard/recruitment', icon: LayoutDashboard, label: 'Overview', exact: true,
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'HEAD_OF_SALES'] },
...
const salesNavItems = [
  { href: '/dashboard/sales', icon: TrendingUp, label: 'Sales Overview', exact: true,
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'SALES_MANAGER', 'SALES_AGENT', 'FINANCE_OFFICER', 'HEAD_OF_SALES'] },
  { href: '/dashboard/sales/leads', icon: Target, label: 'Leads',
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'SALES_MANAGER', 'SALES_AGENT', 'HEAD_OF_SALES'] },
  ...
  { href: '/dashboard/sales/subscriptions', icon: RotateCcw, label: 'Subscriptions',
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'SALES_MANAGER', 'FINANCE_OFFICER', 'HEAD_OF_SALES'] },
  ...
  { href: '/dashboard/sales/portfolio', icon: FolderOpen, label: 'Portfolio',
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'SALES_MANAGER', 'SALES_AGENT', 'FINANCE_OFFICER', 'EMPLOYEE', 'HEAD_OF_SALES'] },
  { href: '/dashboard/sales/letters', icon: Mail, label: 'Official Letters',
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'SALES_MANAGER', 'HEAD_OF_SALES'] },
  { href: '/dashboard/sales/reports', icon: BarChart3, label: 'Sales Reports',
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'SALES_MANAGER', 'FINANCE_OFFICER', 'HEAD_OF_SALES'] },
  { href: '/dashboard/sales/team', icon: UserCheck, label: 'Sales Team',
    roles: ['SALES_MANAGER', 'HEAD_OF_SALES'] },
  ...
  { href: '/dashboard/sales/targets', icon: Target, label: 'Sales Targets',
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'HEAD_OF_SALES'] },
  { href: '/dashboard/sales/audit-log', icon: Shield, label: 'Audit Log',
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'SALES_MANAGER', 'HEAD_OF_SALES'] },
]
...
const policiesNavItems = [
  { href: '/dashboard/policies', icon: ScrollText, label: 'Company Policies', exact: true,
    roles: ['SUPER_ADMIN', 'FINANCE_OFFICER', 'HR_MANAGER', 'DEPARTMENT_HEAD', 'EMPLOYEE', 'HEAD_OF_SALES'] },
...
const supportNavItems = [
  { href: '/dashboard/tickets', icon: LifeBuoy, label: 'Support Tickets', exact: false,
    roles: ['SUPER_ADMIN', 'HR_MANAGER', 'SALES_MANAGER', 'SALES_AGENT', 'DEPARTMENT_HEAD', 'FINANCE_OFFICER', 'EMPLOYEE', 'HEAD_OF_SALES'] },
]
